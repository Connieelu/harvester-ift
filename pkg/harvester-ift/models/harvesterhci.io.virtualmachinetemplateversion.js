...
export default class HciVmTemplateVersion extends HarvesterResource {
  ...
  get template() {
    return this.$rootGetters[`${ PRODUCT_NAME }/all`](HCI.VM_TEMPLATE).find((T) => {
  ...
  get templates() {
    return this.$rootGetters[`${ PRODUCT_NAME }/all`](HCI.VM_TEMPLATE);
  }
  ...
  get defaultVersion() {
    const templates = this.$rootGetters[`${ PRODUCT_NAME }/all`](HCI.VM_TEMPLATE);
